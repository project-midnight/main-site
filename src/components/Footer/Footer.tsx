...
// Inline SVG icons for Telegram and Discord
...
const socials: SocialItem[] = [
  { href: 'https://t.me/portcreator_ch', icon: TelegramIcon, label: 'Telegram' },
  { href: 'https://discord.gg/heaqDH2uSD', icon: DiscordIcon, label: 'Discord' },
  { href: 'https://github.com/project-midnight', icon: GitHubIcon, label: 'GitHub' },
];
      ...
      <div className="container">
        <div className={styles.inner}>
          <div className={styles.logo}>
            <img src="/favicon.png" alt="MidnightProject Logo" className={styles.logoIcon} />
