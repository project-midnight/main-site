  ...
  return (
    <section className={styles.section} id="pricing">
      <div className="container">
        ...
        <div className={`${styles.placeholder} reveal`} ref={revealContent}>
          <div className={`${styles.icon} emoji`}>🧪</div>
          <h3 className={styles.heading}>{t('pricing.heading')}</h3>
          <p className={styles.text}>{t('pricing.text')}</p>

          <div className={styles.contactLabel}>{t('pricing.contact')}</div>
